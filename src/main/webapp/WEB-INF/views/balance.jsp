    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div>
                    <h2 class="form-group">收货地址</h2>
                </div>
                <form method="post" accept-charset="utf-8" id="address_form">
                    <div class="form-group">
                        <label>手机号码</label>
                        <input type="text" class="form-control input-lg" name="phone" id="phone" value="${user.phone}">
                    </div>
                    <div class="form-group">
                        <label>邮编</label>
                        <input type="text" class="form-control input-lg" name="code" id="code" value="${user.code}">
                    </div>
                    <div class="form-group">
                        <label>地址</label>
                        <input type="text" class="form-control input-lg" name="address" id="address" value="${user.address}">
                    </div>
                    <div class="form-group">
                        <label>密码</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary pull-right">结算</button>
                        </div>
                    </div>
                </form>
            </div>
