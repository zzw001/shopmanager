...
function ezq(args){
    ...
    var confirm = $('<button type="button" class="btn btn-primary" data-dismiss="modal">确认</button>');
...
function plus(args){
    ...
    var obj = $(res);
    var deny = '<button type="button" class="btn btn-danger" data-dismiss="modal">取消</button>';
    var confirm = $('<button type="button" class="btn btn-primary" data-dismiss="modal">添加</button>');
